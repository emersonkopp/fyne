<p align="center">
  <a href="https://pkg.go.dev/github.com/emersonkopp/fyne?tab=doc" title="Go API Reference" rel="nofollow"><img src="https://img.shields.io/badge/go-documentation-blue.svg?style=flat" alt="Go API Reference"></a>
  ...
  <br />
  <a href="https://goreportcard.com/report/github.com/emersonkopp/fyne"><img src="https://goreportcard.com/badge/github.com/emersonkopp/fyne" alt="Code Status" /></a>
...
[Getting Started](https://github.com/emersonkopp/develop/) document.

Using the standard go tools you can install Fyne's core library using:

    go get github.com/emersonkopp/fyne@latest
...
To run a showcase of the features of Fyne execute the following:
    ...
    go install github.com/emersonkopp/fyne/cmd/fyne_demo@latest
    fyne_demo
...
application location you can use the fyne utility and the "install" subcommand.
    ...
    go install github.com/emersonkopp/fyne/cmd/fyne@latest
    fyne install
...
More documentation is available at the [Fyne developer website](https://developer.github.com/emersonkopp/) or on [pkg.go.dev](https://pkg.go.dev/github.com/emersonkopp/fyne?tab=doc).

# Examples

You can find many example applications in the [examples repository](https://github.com/fyne-io/examples/).
Alternatively a list of applications using fyne can be found at [our website](https://apps.github.com/emersonkopp/).
...
| ------------- | ----------------------------------- | ---------------------------------------------------------------------- |
| fyne_settings | `github.com/emersonkopp/fyne/cmd/fyne_settings` | A GUI for managing your global Fyne settings like theme and scaling    |
