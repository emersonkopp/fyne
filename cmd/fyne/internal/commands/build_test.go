	...
	expected := []mockRunner{
		{
			...
			mockReturn: mockReturn{
				ret: []byte("{ \"Module\": { \"Path\": \"github.com/emersonkopp/fyne\"} }"),
			},
		},
		{
			expectedValue: expectedValue{args: []string{"version"}},
...
func Test_FyneGoMod(t *testing.T) {
	jsonTests := []jsonTest{
		{false, []byte(`{"Module": {"Path": "github.com/fyne-io/calculator"},"Go": "1.14",	"Require": [ { "Path": "github.com/emersonkopp/fyne","Version": "v2.1.4"} ] }`)},
		{true, []byte(`{ "Module": {"Path": "github.com/emersonkopp/fyne"},"Require": [{ "Path": "test","Version": "v2.1.4"} ] }`)},
		{true, []byte(`{"Module": {"Path": "github.com/fyne-io/calculator"},"Go": "1.14",	"Require": [ { "Path": "github.com/emersonkopp/fyne","Version": "v2.2.0"} ] }`)},
	}
